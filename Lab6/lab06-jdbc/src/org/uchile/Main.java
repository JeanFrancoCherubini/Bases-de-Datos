...
public class Main {
	...
	private static final String PREFIX = "org.uchile.";
	...
	public static void main(String[] args) {
		try {
			if (args.length < 1) {
				...
				sb.append("\n\t"+ApellidoApp.class.getSimpleName()+": Encontrar sueldos por apellido");
				sb.append("\n\t"+ApellidoAppSegura.class.getSimpleName()+": Encontrar sueldos por apellido (segura)");
